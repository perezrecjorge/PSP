package UT3.EJEMPLOS_DB4O.Ejercicio1Ampliacion;
...
public class AccesoDatos {
    ...
    //INSERTAR UN DEPARTAMENTO EN LA BD
	public String InsertarDep(Departamentos d) {
		String cadena="";
		//comprobar si existe el departamento
		Departamentos dep = new Departamentos (d.getDeptNo());
		ObjectSet<Departamentos> result = db.queryByExample(dep);
		int num=result.size();
		if (num == 0){			
			db.store(d);
			cadena = "Departamento insertado...";
		}			
		else 		
		cadena = "El departamento ya existe...";
